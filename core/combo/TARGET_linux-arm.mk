...
ifeq ($(strip $(SM_TOOLCHAIN_VARIANT)),)
...
ifeq ($(HOST_OS),linux)
$(combo_2nd_arch_prefix)TARGET_TOOLCHAIN_ROOT := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/$(SM_TOOLCHAIN_VARIANT)-arm-linux-androideabi-$($(combo_2nd_arch_prefix)TARGET_GCC_VERSION)
endif
endif
